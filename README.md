...
<br>🔭 Trabalho atualmente como **Desenvolvedora Full Stack** e utilizo com mais frequência **TypeScript** no **Vue.js** em **Composition API** no front, **#C** no **.Net** no back, **Python** na implementação de programas que utilizam **I.A.** e **Machine Learning** e **PostgreSQL** no banco de dados.<br>
